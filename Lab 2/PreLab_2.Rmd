...
output$code_1_2 <- renderText(
        makePrintText(
          base_string = bs_1_2(),
          old_input = c(),
          new_input = c(input$k, input$n2, input$p2)
        )
  )
...
output$check_1.1 <- renderText(
  if(round(input$a_1.1,2) == round(dbinom(50, 100, .5), 2)){
      correct
  }else if(input$a_1.1 == ""){
     ""
  }else{
...
output$check_1.2 <- renderText(
  if(round(input$a_1.2,2) == round(pbinom(44, 100, .5), 2)){
      correct
  }else if(input$a_1.2 == ""){
     ""
  }else{
...
output$check_1.3 <- renderText(
  if(round(input$a_1.3,2) == round(1-pbinom(7, 43, .1), 2)){
      correct
  }else if(input$a_1.3 == ""){
     ""
  }else{
...
output$check_1.4 <- renderText(
  if(round(input$a_1.4,2) == round(qbinom(.8, 20, .1), 2)){
      correct
  }else if(input$a_1.4 == ""){
     ""
  }else{
