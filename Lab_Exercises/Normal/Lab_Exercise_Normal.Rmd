...
bs_1 = reactive("pnorm(x = %ni, mean = %ni, sd = %ni)")
...
bs_3 = reactive("qnorm(p = %ni, mean = %ni, sd = %ni)")
...
output$check_3.3 <- renderText(
  if(input$a_3.3 == ""){
     ""
  }else if(round(as.numeric(input$a_3.2),2) == round(qnorm(.75, 1600, 200), 2)){
      correct
  }else{
    incorrect
  }
...
output$check_4.3 <- renderText(
  if(input$a_4.3 == ""){
     ""
  }else if(as.numeric(input$a_4.3) == 9){
      correct
  }else{
    incorrect
  }
...
output$check_4.4 <- renderText(
  if(input$a_4.4 == ""){
     ""
  }else if(as.numeric(input$a_4.4) == 0.84){
      correct
  }else{
    incorrect
  }
