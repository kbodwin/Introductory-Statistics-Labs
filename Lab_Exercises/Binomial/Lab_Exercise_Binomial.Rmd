...
if(file.exists("./Lab_Exercise_Binomial.html")){
  file.remove("./Lab_Exercise_Binomial.html")
}
...
In this exercise, we will be using **R** to calculate information about Binomial random variables.  
