...
bs_2 <- reactive("ggplot(%oi, aes(x = %ni)) + geom_%oi(bins = %ni, fill = '%ni') + ggtitle('%ni') + xlab('%ni')")
# 
htmlOutput("code_2")
# 
plotOutput("plot_2")
...
bs_3 <- reactive("ggplot(%oi, aes(x = %oi)) + geom_%oi(%nibins = %oi, fill = '%oi') %ni+ ggtitle('%oi') + xlab('%oi')")
# 
htmlOutput("code_3")
# 
plotOutput("plot_3")
