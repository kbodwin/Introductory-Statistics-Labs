...
In this data, the mean number of points scored by a single team in a college basketball game is [------].  The standard deviation is [------].
...
For a Normally distributed random variable, with the mean and standard deviation given above, the probability of observing a value at or below 52 is [------].
...
In the game on January 16, 2016, UCSB scored [-----] points.  In the 2015-16 season, [------]% of all team scores were below what UCSB scored on January 16th.
...
```{r}
### Code for your calculations here
```
