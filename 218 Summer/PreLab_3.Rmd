...
# Read Data
colleges = read.csv('https://raw.githubusercontent.com/kbodwin/ShinyLabs/master/Datasets/colleges1995.csv')
...
output$check_3.1 <- renderText(
  if(round(as.numeric(input$a_3.1),1) == 3 | round(as.numeric(input$a_3.1),1) == -3){
      correct
  }else{
    incorrect
  }
...
output$check_4 <- renderText(
  if(round(as.numeric(input$a_4), 2) == 0.04){
      correct
  }else{
    incorrect
  }
